...
class TermGoalSender:
    ...
    def sendGoal(self):
        ...
        if self.is_home:
            ...
            self.term_goal.pose.position.x = self.wps[self.wpidx % 4][0]
            self.term_goal.pose.position.y = self.wps[self.wpidx % 4][1]
            self.term_goal.pose.position.z = self.wps[self.wpidx % 4][2]

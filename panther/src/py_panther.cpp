...
.def_readwrite("color_type", &mt::parameters::color_type)                      
...
.def_readwrite("stop_time_when_replanning", &mt::parameters::stop_time_when_replanning)       
.def_readwrite("replanning_trigger_time", &mt::parameters::replanning_trigger_time)         

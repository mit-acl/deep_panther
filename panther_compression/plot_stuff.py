...
teacher_logs = load_teacher_logs(seeds = seeds, log_prefix = "evals/log_dagger", n_iterations = 10, agent_name="expert")
dagger_logs = load_student_logs(seeds = seeds, log_prefix = "evals/log_dagger", n_iterations = 10, agent_name="student w DAgger")
